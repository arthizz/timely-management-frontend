...
export default function OurTeamCards({employeeName, jobTitle, jobDescription, profilePhoto}: ourTeamTypes){
    ...
    return (
        ...
        <div className="cards">
            <div className="card-top relative bg-gradient-to-r from-blue-500 via-blue-800 via-blue-900 to-blue-950 rounded-t-lg p-5 max-h-20 min-h-20 grid justify-items-center">
                <img src={profilePhoto} alt="teammate" className="h-20 w-20 rounded-full z-10 border-3 border-gray-100" />
            </div>
