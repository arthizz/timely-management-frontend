    ...
    return (
        ...
        <>
            <div className="text-gray-500 grid grid-cols-1 md:grid-cols-3 gap-4 mb-5">
                <div className="radio">
                    <input type="radio" id="sick-leave" name="leave-purpose" value="sick-leave" onChange={togglePersonalLeave} />
                ...
                <div className="radio">
                    <input type="radio" id="bereavement" name="leave-purpose" value="bereavement" onChange={togglePersonalLeave}/>
                ...
                <div className="radio">
                    <input type="radio" id="maternity" name="leave-purpose" value="maternity" onChange={togglePersonalLeave} />
                ...
                <div className="radio">
                    <input type="radio" id="paternity" name="leave-purpose" value="paternity" onChange={togglePersonalLeave}/>
                ...
                <div className="radio">
                    <input type="radio" id="personal" name="leave-purpose" value="personal" onChange={togglePersonalLeave}/>
